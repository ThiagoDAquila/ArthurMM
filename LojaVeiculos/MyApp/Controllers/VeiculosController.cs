...
namespace MyApp.Controllers
{
    public class VeiculosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Cor,Ano,Quilometragem,Valor")] Veiculo veiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Cor,Ano,Quilometragem,Valor")] Veiculo veiculo)
        {
            if (id != veiculo.Id)
            {
                return NotFound();
